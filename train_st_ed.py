...
def execute_test(log, current_step):
    ...
    for name, subject, index_dataset, dataloader in dataloader_all:
        ...
        for index,entry in enumerate(dataloader):
            ...
            batch_images_gt[nonhead_mask_c3b] = 0.8
            ...
            batch_images_gen[nonhead_mask_c3b] = 0.8

            #batch_images_gen[nonhead_mask_c3b][:,0,:,:] = 29.0 / 255
            #batch_images_gen[nonhead_mask_c3b][:,1,:,:] = 90.0 / 255
            #batch_images_gen[nonhead_mask_c3b][:,2,:,:] = 30.0 / 255
